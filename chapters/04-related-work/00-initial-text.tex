...
Understanding and admitting that not every systematic approach contributes negatively to rigorous and well-conducted qualitative research is necessary. A systematic approach can provide a solid foundation to help other researchers adequately posit their investigation into the major network of produced knowledge. In this project, I use a systematic mapping instead of a systematic review. \citeonline[p.~1]{petersen:2015} establish the distinction between them:
\begin{citacao}
