...
Second, my advisors and I situated emerged equity issues from the \glspl{LLM} in (computing) education \cite{bispojr:2024-nmp}, emphasizing what we called "Prompt Literacy" and the arising of \gls{LLM}
